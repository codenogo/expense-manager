      ...
      <header className="bg-card border-b border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Manage your household accounts</p>
          </div>
          <Link
            href="/accounts/new"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        {accounts.length === 0 ? (
          <div className="bg-card rounded-xl border border-border p-10 text-center">
            <p className="text-muted-foreground text-sm mb-4">No accounts yet. Add your first account to get started.</p>
            <Link
              href="/accounts/new"
              className="bg-primary text-primary-foreground rounded-lg px-4 py-2 text-sm font-medium hover:bg-primary/90 transition-colors"
            >
